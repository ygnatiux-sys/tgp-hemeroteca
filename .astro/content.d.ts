...
declare module 'astro:content' {
	...
	type DataEntryMap = {
		"arquetiposGlobales": Record<string, {
  id: string;
  body?: string;
  collection: "arquetiposGlobales";
...
"arquetiposGlobalesContent": Record<string, {
  id: string;
  body?: string;
  collection: "arquetiposGlobalesContent";
  data: any;
  rendered?: RenderedContent;
  filePath?: string;
  digest?: string | number;
...
"georreferenciasContent": Record<string, {
  id: string;
  body?: string;
  collection: "georreferenciasContent";
  data: any;
  rendered?: RenderedContent;
  filePath?: string;
  digest?: string | number;
